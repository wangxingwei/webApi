...
<!--左侧菜单结束-->
<div class="rightcon">
    <iframe id="iframe_context" src="/common/menuforward.html?url=welcome" name="frmright" scrolling="yes" frameborder="0" style="border: 0px; height: 100%; width: 100%;sallowTransparency:true ;" >
    </iframe>
</div>
