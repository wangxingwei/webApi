...
<div class="page-container">
    <form action="" method="post" >
        <div class="search-layout clearfix">
            ...
            <button type="button" class="btn btn-info" onclick="javascript:window.location='/common/menuforward.html?url=/function/mngr/add_sale'">新增</button>
        </div>
        <div class="search-layout clearfix margin_top10">
            <label>活动名称:</label>
            <input type="text" placeholder="请输入活动名称"  name="" class="form-control" >
            <label>活动形式:</label>
            <select name="" class="form-control float_left" >
                <option value="">全部</option>
                <option value="1">满减</option>
                <option value="2">满赠(固定额)</option>
                <option value="3">满赠(百分比)</option>
            </select>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#edit_btn").click(function(){
            ...
            alert(id);
            if(id!=null && id!=""){
                window.location='/common/menuforward.html?url=/function/mngr/add_sale';
            }else{
                alert("请选择一条记录!");
            }
        });
