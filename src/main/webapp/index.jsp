<<jsp:forward page="/WEB-INF/view/pages/index.jsp"></jsp:forward>
...
<head>
    ...
    <script type="text/javascript" src="/static/js/menu.js"></script>    <style>
...
<nav class="navbar navbar-default" style="margin-bottom:0px;">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <img src="/static/images/logo.png" height="60px" style="vertical-align:middle;"/><span class="nav-title">&nbsp;&nbsp;惠付通后台管理系统</span>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <c:if test="${sessionScope.login == 'login' or sessionScope.manger == 'manger'}">
                        <a href="/WEB-INF/view/common/powerindex.html" target="_blank" style="font-size:18px;font-weight:bold;"><i class="glyphicon glyphicon-lock"></i>权限管理 <span class="sr-only">(current)</span></a>
                    </c:if>
                </li>
...
<!--左侧菜单开始-->
<div class="nav-down">
    <jsp:include page="/WEB-INF/view/pages/left.jsp"/>
</div>
<!--左侧菜单结束-->
<!-- <div class="rightcon">
    <iframe id="iframe_context" src="/WEB-INF/view/common/menuforward.html?url=welcome" name="frmright" scrolling="yes" frameborder="0" style="border: 0px; height: 100%; width: 100%;sallowTransparency:true ;" >
    </iframe>
</div> -->
